...
export default function AboutSection({ onOpenResumeModal }: AboutSectionProps) {
  ...
  return (
    <section id="about" className="py-20 lg:py-28 relative bg-slate-950/60 border-t border-b border-slate-800/80">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
          ...
          <div className="lg:col-span-5 relative">
            <div className="relative rounded-3xl overflow-hidden glass-card p-3 border border-slate-800 bg-slate-900/60 shadow-2xl">
              <div className="relative aspect-[4/5] rounded-2xl overflow-hidden group">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl glass-card bg-slate-950/90 border border-white/10">
                  <p className="text-xs text-blue-400 font-semibold tracking-wider uppercase mb-0.5">
                    Creative Mindset
                  </p>
